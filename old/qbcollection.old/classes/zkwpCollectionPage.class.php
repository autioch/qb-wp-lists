...
class zkwpCollectionPage {
    ...
    public function editItem() {
        if (isset($_POST['zkwp_form']) && isset($_POST['zkwp_form']['delete'])) {
            return $this->deleteItem();
        }
        $form = $this->getForm();
        if ($form->validate()) {
            $this->saveItem($form->getAll());
            if (isset($_POST['zkwp_form']) && isset($_POST['zkwp_form']['submitreturn'])) {
                $form->stripSlashes();
                echo $this->getTitle();
                return $form->render();
            } else {
    ...
    protected function getEditLink($id) {
        return '<a class="zkwp-tools-edit" title="Edytuj pozycję" href="?page=' . $this->page . '&action=edit&id=' . $id . '"></a>';
    }

    protected function getDeleteLink($id) {
        return '<a class="zkwp-tools-delete" title="Usuń pozycję" href="?page=' . $this->page . '&action=delete&id=' . $id . '"></a>';
    }
