...
class zkwpView
{
    ...
    public function echoImage($item) {
        if ($item->image) {
            echo '<img src="', ZKWP_TOOLS_URL, 'public/images/loading.png" class="qbc-item-image" data-src="', $item->image, '" alt=""/>';
        }
    }
    ...
    public function echoDisclosure() {
        ?>
        <p class="qbc-disclosure">Wszelkie informacje zawarte na tej stronie zostały podane przez 
            właścicieli hodowli. W celu aktualizacji danych prosimy o przesłanie informacji na adres 
            <a href="mailto:biuro@zkwp-koszalin.pl">biuro@zkwp-koszalin.pl</a>.</p>
        <?php
    }
}
